...
public class InvitedScheduleController {
    ...
    @DeleteMapping("/schedules/refuse/{scheduleId}")
    public ApiResponse<Void> refuseSchedule(@PathVariable Long scheduleId,
                                            @AuthenticationPrincipal Long refuserId){
        invitedScheduleService.refuseInvitedSchedule(scheduleId, refuserId);
        return ApiResponse.of(SuccessStatus._OK, null);
    }
}
